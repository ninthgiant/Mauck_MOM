...
As of June 9, 2024, the latest version is MOM_GUI_v07.py. It is reorganized and commented. It calls other .py files that contain some of the code from the original v_05.py codebase. The other files need to be in the same folder to make it work. The other files are:
