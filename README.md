...
In the same folder (directory) you need to have both the MOM_GUI_v01.py and the MOM_GUI_set_user_values.py files. You should change settings in MOM_GUI_set_user_values.py to match your local machine.
